    ...
    public before() {
        ...
        c.bind(WorkspaceManagerClientProviderSource).toDynamicValue((): WorkspaceManagerClientProviderSource => {
            const cluster: WorkspaceCluster[] = [
                { name: "c1", govern: false, governedBy: "app1", maxScore: 100, score: 0, state: "cordoned", url: "", admissionConstraints: [] },
                { name: "c2", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "cordoned", url: "", admissionConstraints: [] },
                { name: "c3", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "cordoned", url: "", admissionConstraints: [] },
                { name: "a1", govern: false, governedBy: "app1", maxScore: 100, score: 0, state: "available", url: "", admissionConstraints: [] },
                { name: "a2", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "available", url: "", admissionConstraints: [] },
                { name: "a3", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "available", url: "", admissionConstraints: [] },
                {
                    name: "con1", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "available", url: "", admissionConstraints: [
                        { type: "has-permission", permission: "new-workspace-cluster" },
                    ]
                },
                {
                    name: "con2", govern: false, governedBy: "app1", maxScore: 100, score: 50, state: "available", url: "", admissionConstraints: [
